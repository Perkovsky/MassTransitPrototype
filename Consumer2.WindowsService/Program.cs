...
using Consumer2.WindowsService.Consumers;
using Contracts;
using MassTransit;
    ...
    class Program
    {
        ...
        static Program()
        {
            ...
            var receiveEndpoints = new List<ReceiveEndpointRegistration>
            {
                new ReceiveEndpointRegistration(
                    ...
                    consumers: new List<Type> { typeof(UserUpdated2Consumer) }
                ),
            };
        ...
        static void Main(string[] args)
        {
            ...
            HostFactory.Run(x =>
            {
                ...
                x.SetDescription("Consumer 2 Windows Service Prototype");
                x.SetDisplayName("Consumer 2 Windows Service");
                x.SetServiceName("Consumer 2 Windows Service");
            });
        }
    }
}
